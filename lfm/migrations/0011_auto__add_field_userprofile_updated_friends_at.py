...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.updated_friends_at'
        db.add_column('lfm_userprofile', 'updated_friends_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.updated_friends_at'
        db.delete_column('lfm_userprofile', 'updated_friends_at')
