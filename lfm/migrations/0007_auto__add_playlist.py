...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lfm_playlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('lfm', ['Playlist'])

        # Adding M2M table for field tracks on 'Playlist'
        db.create_table('lfm_playlist_tracks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playlist', models.ForeignKey(orm['lfm.playlist'], null=False)),
            ('track', models.ForeignKey(orm['lfm.track'], null=False))
        ))
        db.create_unique('lfm_playlist_tracks', ['playlist_id', 'track_id'])


    def backwards(self, orm):
        
        # Deleting model 'Playlist'
        db.delete_table('lfm_playlist')

        # Removing M2M table for field tracks on 'Playlist'
        db.delete_table('lfm_playlist_tracks')
