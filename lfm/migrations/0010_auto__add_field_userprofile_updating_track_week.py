...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.updating_track_week'
        db.add_column('lfm_userprofile', 'updating_track_week', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.updating_track_week'
        db.delete_column('lfm_userprofile', 'updating_track_week')
