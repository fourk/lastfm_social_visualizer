...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playlist.ordering'
        db.add_column('lfm_playlist', 'ordering', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='1,2,3', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playlist.ordering'
        db.delete_column('lfm_playlist', 'ordering')
