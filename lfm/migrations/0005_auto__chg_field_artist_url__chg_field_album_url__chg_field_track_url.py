...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Artist.url'
        db.alter_column('lfm_artist', 'url', self.gf('django.db.models.fields.URLField')(max_length=150, null=True))

        # Changing field 'Album.url'
        db.alter_column('lfm_album', 'url', self.gf('django.db.models.fields.URLField')(max_length=150, null=True))

        # Changing field 'Track.url'
        db.alter_column('lfm_track', 'url', self.gf('django.db.models.fields.URLField')(max_length=150, null=True))
