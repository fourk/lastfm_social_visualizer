...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.tracks_week_updated_at'
        db.add_column('lfm_userprofile', 'tracks_week_updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.tracks_week_updated_at'
        db.delete_column('lfm_userprofile', 'tracks_week_updated_at')
