...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Artist.url'
        db.alter_column('lfm_artist', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

        # Changing field 'Album.url'
        db.alter_column('lfm_album', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

        # Changing field 'Image.url'
        db.alter_column('lfm_image', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'Track.url'
        db.alter_column('lfm_track', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))


    def backwards(self, orm):
        
        # Changing field 'Artist.url'
        db.alter_column('lfm_artist', 'url', self.gf('django.db.models.fields.URLField')(max_length=250, null=True))

        # Changing field 'Album.url'
        db.alter_column('lfm_album', 'url', self.gf('django.db.models.fields.URLField')(max_length=250, null=True))

        # Changing field 'Image.url'
        db.alter_column('lfm_image', 'url', self.gf('django.db.models.fields.URLField')(max_length=254))

        # Changing field 'Track.url'
        db.alter_column('lfm_track', 'url', self.gf('django.db.models.fields.URLField')(max_length=250, null=True))
